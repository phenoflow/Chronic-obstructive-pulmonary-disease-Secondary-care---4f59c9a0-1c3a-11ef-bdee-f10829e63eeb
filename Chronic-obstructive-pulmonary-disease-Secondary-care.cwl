...
steps:
  ...
  lower-chronic-obstructive-pulmonary-disease-copd-secondary-care---secondary:
    run: lower-chronic-obstructive-pulmonary-disease-copd-secondary-care---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  other-chronic-obstructive-pulmonary-disease-copd-secondary-care---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: lower-chronic-obstructive-pulmonary-disease-copd-secondary-care---secondary/output
  chronic-obstructive-pulmonary-disease-copd-secondary-care-asthmaticu---secondary:
    run: chronic-obstructive-pulmonary-disease-copd-secondary-care-asthmaticu---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  chronic-obstructive-pulmonary-disease-copd-secondary-care-bronchiectasis---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: chronic-obstructive-pulmonary-disease-copd-secondary-care-asthmaticu---secondary/output
